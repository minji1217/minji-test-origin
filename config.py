...
SIMILARITY_THRESHOLD = 0.65  # FAISS 코사인 유사도 최소 임계값
FULL_TOPK = 5000    # paper query 기준 추려올 후보 논문 개수 
TITLE_TOPK = 1000
ABSTRACT_TOPK = 1000
FULL_WT = 0.75
TITLE_WT = 0.15
...
PAPER_SIM_WEIGHT = 0.42     # 가중합 비율 (paper_query) 
CONTEXT_SIM_WEIGHT = 0.58    # 가중합 비율 (context_query)
